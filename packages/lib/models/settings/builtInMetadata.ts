				...
				({
					...
					options: () => {
						...
						return {
							...
							[Setting.FONT_VAZIRMATN]: 'Vazirmatn',
							[Setting.FONT_ESTEDAD]: 'Estedad',
							[Setting.FONT_SAHEL]: 'Sahel',
							[Setting.FONT_SHABNAM]: 'Shabnam',
							[Setting.FONT_SAMIM]: 'Samim',
							[Setting.FONT_TANHA]: 'Tanha',
							[Setting.FONT_GANDOM]: 'Gandom',
							[Setting.FONT_PARASTOO]: 'Parastoo',
							[Setting.FONT_MIKHAK]: 'Mikhak',
							[Setting.FONT_LALEZAR]: 'Lalezar',
							[Setting.FONT_VAZIR_CODE]: 'Vazir Code',
							[Setting.FONT_NOTO_SANS_ARABIC]: 'Noto Sans Arabic',
							[Setting.FONT_NOTO_KUFI_ARABIC]: 'Noto Kufi Arabic',
							[Setting.FONT_IBM_PLEX_SANS_ARABIC]: 'IBM Plex Sans Arabic',
							[Setting.FONT_VAZIRHARF]: 'VazirHarf',
						};
					},
					storage: SettingStorage.File,
					isGlobal: true,
